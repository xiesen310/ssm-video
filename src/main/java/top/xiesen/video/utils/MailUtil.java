...
public class MailUtil {
    //修改为自己的qq邮箱账号
    private static String myEmailAccount = "1772934813@qq.com";
    //修改为自己的邮箱授权码
    private static String myEmailPassword = "irfxlzxphjrcegbi";
    ...
    public static String createRandom(){
        ...
        Integer ran = random.nextInt((99999-10000+1)+10000);
        return ran + "";
    }
