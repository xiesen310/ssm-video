...
public class VideoServiceImpl implements VideoService{
	...
	@Override
	public List<Video> selectVideoInId(String substring) {
		return vm.selectVideoInId(substring);
	}

	@Override
	public List<Video> selectVideoByCourse(Integer course_id) {
		return vm.selectVideoByCourse(course_id);
	}

	@Override
	public void updateVideoPlayTimes(int i,int id) {
		vm.updateVideoPlayTimes(i,id);
	}
