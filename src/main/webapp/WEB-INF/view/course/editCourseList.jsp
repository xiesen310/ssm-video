...
<html lang="zh-CN">
	...
	<!-- 导航栏结束 -->
		...
		<div class="container">
			...
			<form class="form-horizontal" action="${pageContext.request.contextPath }/course/editCourse.action?id=${course.id}" method="post">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" value="${course.course_name}" name="course_name"  placeholder="请填标题">
					</div>
				</div>
