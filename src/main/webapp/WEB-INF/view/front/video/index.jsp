...
<div>
    ...
    <script src="<c:url value="/static/js/video.js"/>"></script>
    <script>
        $(function () {
        	var id = $('#videoId').val();
           $('#content').load('/video/front/video/videoData.action?videoId='+id);
           
           //播放量统计,不需要返回结果处理
           $.get('/video/front/video/state.action?videoId='+id);
		});
    </script>
</body>
