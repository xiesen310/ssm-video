...
<head>
    ...
    <link rel="stylesheet" href="<c:url value="/static/css/forget_password.css"/>">
    <link rel="icon" href="favicon.png" type="image/png">
    <title>在线公开课-智游教育|java|大数据|HTML5|python|UI|PHP视频教程</title>
    <script src="<c:url value="/js/jquery-1.12.4.min.js"/>"/>
    <link rel="stylesheet"  href="<c:url value="/css/jquery-confirm.css"/>"/>
    <script src="<c:url value="/js/jquery-confirm.js"/>" ></script>
    <script type="text/javascript" src="<c:url value="/js/jquery.validate.min.js"/>"></script>
    <script type="text/javascript" src="<c:url value="/js/messages_zh.min.js"/>"></script>
...
<body>
    ...
    <main>
        <div class="container">
            <form class="ma" action="<c:url value="/front/user/forgetpwd.action"/>" method="post" id="checkForm">
                <div class="form_header">
                    ...
                    <div class="form_back">
                        <a href="<c:url value="/front/toIndex.action"/>">返回立即登录</a>
                    </div>
                </div>
                <div class="form_body">
