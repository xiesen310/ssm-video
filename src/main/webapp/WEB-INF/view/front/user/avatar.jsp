        ...
        <div class="container">
            ...
            <div id="profile_tab">
               <ul class="profile_tab_header f_left clearfix">
                    <li><a href="<c:url value="/front/user/profile.action"/>">更改资料</a></li>
                    <li class="profile_tab_line">|</li>
                    <li><a href="<c:url value="/front/user/avatar.action"/>">更改头像</a></li>
                    <li class="profile_tab_line">|</li>
                    <li><a href="<c:url value="/front/user/password.action"/>">密码安全</a></li>
                </ul>
                <div class="proflle_tab_body">
                    <div class="proflle_tab_workplace clearfix">
                        <div class="profile_avatar_area">
                            <c:if test="${empty user.head_url}">
                                 <img  src="<c:url value="/static/img/avatar_lg.png"/>">
                            </c:if>
                        ...
                        <div class="profile_ifo_area">
                            <form id="upload_form" enctype="multipart/form-data" method="post" action="<c:url value="/front/user/avatar.action"/>" >
                                ...
                                <input type="file" class="form-control" name="image_file" id="image_file" accept="image/png,image/jpeg,image/jpg"/><br>
