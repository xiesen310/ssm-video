	...
	<div class="container">
		...
		<c:if test="${not empty user}">
			<div id="userBlock" style="float:right">
				...
				<a href="<c:url value="/front/user/index.action"/>" id="account">${sessionScope.user.email }</a>
			</div>
		</c:if>
		...
		<a target="_blank" href="<c:url value="/admin/login.action"/>"><img src="<c:url value="/static/img/we.png"/>" draggable="false">后台管理</a>
