...
<html lang="zh-CN">
	...
	<!-- 导航栏结束 -->
		...
		<div class="container">
			...
			<form class="form-horizontal" action="${pageContext.request.contextPath }/speaker/editSpeaker.action?id=${speaker.id}" method="post">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" name="speaker_job" value="${speaker.speaker_job }" placeholder="请填写主讲人职业">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" name="speaker_head_url" value="${speaker.speaker_head_url }" placeholder="图片地址">
					</div>
				</div>
